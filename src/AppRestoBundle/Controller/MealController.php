...
class MealController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $meals = $em->getRepository('AppRestoBundle:Meal')->findAll();
    ...
    {
        $meal = new Meal();
        $form = $this->createForm('AppRestoBundle\Form\MealType', $meal);
    ...
    {
        $deleteForm = $this->createDeleteForm($meal);
        $editForm = $this->createForm('AppRestoBundle\Form\MealType', $meal);
